...
export default function HomePage() {
  ...
  return (
    <div>
        ...
        <div className="relative mx-auto grid max-w-7xl gap-14 px-5 py-24 sm:px-8 lg:grid-cols-[1.1fr_.9fr] lg:py-32">
          <div>
            <Badge tone={apiLive ? "live" : "muted"}>
              <span
                className={
                  ...
                  (apiLive ? "bg-emerald-500" : "bg-zinc-400")
                }
              />
            ...
            <p className="mt-8 max-w-xl text-base leading-7 text-zinc-600 dark:text-zinc-400 sm:text-lg">
              Find your next book, check availability, and keep your reading
              moving.
            </p>
          ...
          <div className="flex items-center justify-center">
            <div className="relative aspect-square w-full max-w-xl">
              <div className="absolute inset-8 rotate-3 border border-zinc-300 dark:border-zinc-700" />
      ...
      <div className="overflow-hidden border-b border-zinc-200 py-5 dark:border-zinc-800">
        <div className="whitespace-nowrap animate-[marquee_24s_linear_infinite]">
          {[...marquee, ...marquee].map((item, index) => (
            <span
              key={item + index}
              className="mx-8 text-xs font-semibold uppercase tracking-[0.28em] text-zinc-500"
            >
      ...
      <section className="mx-auto max-w-7xl px-5 py-24 sm:px-8">
        ...
        <h2 className="mt-3 font-display text-6xl leading-none sm:text-8xl">
          YOUR CATEGORIES.
        </h2>

        <div className="no-scrollbar mt-10 flex gap-5 overflow-x-auto pb-4">
          {(categories.length ? categories : ["Fiction", "Technology", "History", "Biography"]).map(
            (category) => (
              <Link
                key={category}
                href={"/books?search=" + encodeURIComponent(category)}
                className="min-w-[260px] border border-zinc-300 bg-white p-6 transition hover:-translate-y-1 dark:border-zinc-700 dark:bg-zinc-950"
              >
                <p className="text-xs uppercase tracking-[0.18em] text-zinc-500">
                  Category
                </p>
                <h3 className="mt-20 font-display text-4xl">
            ...
            {books.map((book, index) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <Link className="mt-5 inline-block text-sm font-semibold" href={"/books/" + book._id}>
                    View details →
                  </Link>
                </div>
              </motion.article>
          ...
          {[
            ...
            <div key={number} className="border-t-2 border-zinc-900 pt-6 dark:border-white">
              ...
              <p className="mt-3 text-sm leading-6 text-zinc-500">
                Follow the library process and keep your reading list moving.
              </p>
            </div>
          ))}
        </div>
      ...
      <section className="border-t border-zinc-200 dark:border-zinc-800">
        <div className="mx-auto max-w-7xl px-5 py-24 sm:px-8">
          ...
          <div className="mt-10 divide-y divide-zinc-200 border-y border-zinc-200 dark:divide-zinc-800 dark:border-zinc-800">
            {[
              ["What are the opening hours?", "Placeholder — edit this with your real library hours."],
              ["How many books can I borrow?", "Placeholder — add your real borrowing limit here."],
              ["Are there late fees?", "Placeholder — add your actual late-return policy here."],
            ].map(([question, answer]) => (
