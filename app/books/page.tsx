    ...
    <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 sm:py-24">
      <div className="border-b border-zinc-200 pb-12 dark:border-zinc-800">
        ...
        <div className="mt-3 flex flex-col justify-between gap-8 lg:flex-row lg:items-end">
          ...
          <p className="max-w-md text-sm leading-6 text-zinc-500">
            Search the live collection, filter availability, and open a book
            for the full record.
          </p>
        </div>
      </div>
      ...
      <div className="mt-10">
        {loading ? (
          ...
          <ErrorState error={error} onRetry={() => setPage((value) => value)} />
        ) : books.length === 0 ? (
          <EmptyState
            title="No books found."
            message="Try a different search term or availability filter."
          />
        ) : (
